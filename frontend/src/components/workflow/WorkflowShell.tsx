...
export const WORKFLOW_STEPS: WorkflowStep[] = [
  ...
  },
  {
    ...
    outputs: [
      "세대별 주택 수 — 4대 예외룰(소형·저가/상속/일시적 2주택/단독·다가구 합산) 자동 적용",
      "무주택기간 자동 계산 — 만 30세 vs 혼인일 중 빠른 시점 기준",
      "무주택 가점(최대 32점) 산출",
    ],
    commonIssues: [
      {
        issue: "동일 주소가 「전용면적 부분」+「일반」으로 중복 등기",
        solution: "주소 정규화 + 동일 주소 통합으로 자동 1주택 처리됨.",
      },
      {
        issue: "다가구주택 — 호별로 여러 등기 나옴",
        solution: "단독·다가구는 호 수와 무관하게 1주택으로 합산되어 자동 처리됨.",
      },
      {
