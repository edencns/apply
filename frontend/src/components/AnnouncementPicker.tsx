    ...
    <div className="mb-5 rounded-xl border border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50 px-4 py-3">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="flex-1 min-w-0" ref={wrapperRef}>
          <div className="text-[11px] uppercase tracking-wider text-blue-600 font-medium mb-0.5">
            현재 작업 공고
          </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full text-sm font-semibold text-gray-900 bg-white/60 border border-blue-200 rounded-md pl-7 pr-7 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-300"
                  />
                  {open && query && (
                    <button
                      onClick={() => setQuery("")}
                ...
                {/* 완료 포함 체크박스 */}
                <label className="inline-flex items-center gap-1.5 text-xs text-gray-700 cursor-pointer whitespace-nowrap">
                  <input
                    type="checkbox"
                    checked={includeDone}
                    ...
                    filtered.map((a) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left px-3 py-2 hover:bg-blue-50 transition-colors text-sm flex items-center gap-2 ${
                        ...
                        >
                          <span className="flex-1 truncate">
                            ...
                            {a.announcement_no && (
                              <span className="text-gray-400 text-xs ml-1.5">#{a.announcement_no}</span>
                            )}
                          </span>
                          {done && (
                            <span className="text-[10px] bg-gray-200 text-gray-600 px-1.5 py-0.5 rounded">완료</span>
                          )}
                        </button>
                      );
                    })
        ...
        {selected && onOpenDetail && (
          <button
            ...
            className="inline-flex items-center gap-1 text-xs text-blue-700 hover:text-blue-900 font-medium flex-shrink-0"
          >
