...
- 모든 배열 항목에 \`evidenceQuote\`(근거 1~2줄)와 \`evidencePage\`(1부터 시작하는 페이지 번호, 확신 없으면 null) 기재.
...
14. \`requiredDocumentsDetailed\`: 각 서류마다 category(공통/신혼부부 등), 필수/해당시 구분, 발급처, 유효기간(일수), 상세본 여부, 원본 필요 여부.
