...
export const SUPPLY_TYPE_DOCUMENTS: Record<string, string[]> = {
  ...
  '생애최초': [
    // 필수 — 공고 표 「생애최초」 컬럼 기준
    '혼인관계증명서 (상세, 본인)',                              // 본인 혼인 사실 확인 (미혼·기혼 무관)
    '건강보험자격득실확인서 (본인 및 만19세 이상 세대원)',
    '소득증빙서류 (입주자모집공고일 이후 발행)',
    '소득세 납부 입증서류 (5개년도, 본인)',
    '부동산소유현황 (본인 및 세대원)',                          // 등기열람·발급 시스템 발급
    '비사업자 확인각서 (본인 및 만19세 이상 세대원)',
    // 추가(해당자)
    '피부양 직계존속 주민등록초본 (해당 시 — 직계존속 가구원 인정)',
    '자녀 혼인관계증명서 (해당 시 — 만18세 이상 자녀를 미혼 자녀로 인정)',
  ],
  '다자녀가구': [
    // 필수
  ...
  '선착순': [
    // 미분양·잔여세대 직접 분양 — 청약 자격 검증 X. 계약 기본 서류만.
    '신분증 (본인)',
    '계약서',
    '계약금 영수증',
    '인감증명서 또는 본인서명사실확인서',
